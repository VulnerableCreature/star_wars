                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <form action="{{ route('admin.post.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="mt-3">
                                    <img src="{{ asset('storage/'. $post->preview_image) }}" alt="preview_image" class="img-thumbnail w-25">
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                ...
                                <div class="mt-2">
                                    <img src="{{ asset('storage/'. $post->main_image) }}" alt="main_image" class="img-thumbnail w-25">
                                </div>
                            </div>
